...
const RUNTIME_KEYS: Readonly<Record<string, MessageKey>> = {
  ...
  "Checking the local AI runtime.": "startup.runtimeChecking",
  "Downloading Python 3.12.8 from the official Python package server.": "startup.pythonDownloading",
  "Installing the local Python runtime.": "startup.pythonInstalling",
  "Initializing and validating the local CUDA AI runtime.": "startup.runtimeValidating",
  "Local AI dependencies installed.": "startup.runtimeInstalled",
